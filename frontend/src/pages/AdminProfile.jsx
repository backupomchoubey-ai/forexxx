...
const AdminProfile = () => {
  ...
  const handleChangeEmail = async (e) => {
    ...
    if (!emailData.password) {
      setEmailError('Password is required for verification')
      return
    }
    ...
    try {
      const token = localStorage.getItem('adminToken')
      const res = await fetch(`${API_URL}/admin-mgmt/change-email`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
      ...
      if (data.success) {
        ...
        const updatedAdmin = { ...admin, email: emailData.newEmail }
        localStorage.setItem('adminUser', JSON.stringify(updatedAdmin))
        setAdmin(updatedAdmin)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="bg-dark-800 rounded-xl border border-gray-800 p-6 mt-6">
            ...
            <p className="text-gray-500 text-sm mb-6">Update your account email address</p>
            ...
            <form onSubmit={handleChangeEmail} className="space-y-5">
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-2">Password (for verification)</label>
                <div className="relative">
